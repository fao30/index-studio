...
const CardFeatureStudio = ({ data, onClick, onHoverLike }) => {
  ...
  return (
    <div
      ...
      className="cursor-pointer max-w-[13rem] max-h-15 rounded overflow-hidden shadow-lg"
    >
      <div className="w-full h-[15rem] z-0 relative">
        <Swiper
          slidesPerView={1}
          onSlideChange={() => {}}
          onSwiper={(swiper) => {}}
      ...
      <div className="px-4 py-2">
        ...
        <div className="font-bold text-xs mb-2">{data?.title}</div>
        <div className="flex justify-between">
...
export default CardFeatureStudio;
